...
export default function LoginForm({ className, ...props }: UserAuthFormProps) {
    ...
    async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        setIsLoading(true)
        const loginForm = (event.target as HTMLFormElement).id;
    ...
    return (
        <div className={cn("grid gap-6", className)} {...props}>
            <form id="credentials" onSubmit={onSubmit}>
            ...
            <form id="magiclink" onSubmit={onSubmit}>
                <div className="grid gap-2">
                    <div className="grid gap-1">
            ...
            <form id="google" onSubmit={onSubmit}>
            ...
            <form id="github" onSubmit={onSubmit}>
                <Button className="w-full" variant="outline" disabled={isLoading}>
                    {isLoading ? (
                        <Icons.Spinner className="mr-2 h-4 w-4 animate-spin" />
                    ) : (
